...
export default function Producto({id, nombre, precio, imagen_url, tipo}: ProductoProps) {
  return (
    <div className="bg-white text-black rounded-lg p-5 m-5 max-w-[250px] h-[300px] shadow">
        <Link href={'/producto?componente=' + tipo + '&id=' + id}>
          <Image
        ...
        <div className="flex justify-between items-center mt-2">
          <p className="text-[16px] text-black font-bold">USD${precio}</p>
